    ...
    <>
      ...
      <div className="text-lg text-gray-600 space-y-4 relative">
        ...
        <p>
          ...
          trenden. Med <em>Internal Family Systems</em> som grund, förstärkt av
          konkreta verktyg för målsättning, kommunikation och stressreglering,
          guidar jag chefer och team till inre samstämmighet.
        </p>
        <p>
          Genom strukturerade samtal synliggör vi motstridiga drivkrafter och gör
          dem till en resurs i stället för ett hinder. Resultatet blir ledare som
          fattar tydliga beslut och medarbetare som känner sig hörda, delaktiga
          och mindre stressade. Forskning visar att psykologisk trygghet driver
          innovation, sänker sjukfrånvaron och stärker kundrelationer – effekter
