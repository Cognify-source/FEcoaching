...
export default function ForPrivatpersoner() {
  return (
    <Layout>
      ...
      {/* 2) Innehållssektionen – 1/3 bredd, centrerad, utan absolut position */}
      <section className="w-full lg:w-1/3 mx-auto px-6 pt-6">
        ...
        {/* 3) Bilden längst ner till höger i flödet */}
